...
function arlo_menu_type() {

	"use strict";

	jQuery(".arlo_menu_type").one( "mouseover", function (e) {		
		e.preventDefault();
		var animatedMenu = jQuery('.arlo_menu_type');
		animatedMenu.typed({
			strings: ["home();"],
			loop: false,
			//startDelay: 1e3
	...
	jQuery(".arlo_menu_type_about").one("mouseover", function (e) {
		e.preventDefault();
		var animatedMenu = jQuery('.arlo_menu_type_about');
		animatedMenu.typed({
			strings: ["about();"],
			loop: false,
			//startDelay: 1e3
	...
	jQuery(".arlo_menu_type_services").one("mouseover", function (e) {
		e.preventDefault();
		var animatedMenu = jQuery('.arlo_menu_type_services');
		animatedMenu.typed({
			strings: ["services();"],
			loop: false,
			//startDelay: 1e3
	...
	jQuery(".arlo_menu_type_portfolio").one("mouseover", function (e) {
		e.preventDefault();
		var animatedMenu = jQuery('.arlo_menu_type_portfolio');
		animatedMenu.typed({
			strings: ["portfolio();"],
			loop: false,
			//startDelay: 1e3
	...
	jQuery(".arlo_menu_type_news").one("mouseover", function (e) {
		e.preventDefault();
		var animatedMenu = jQuery('.arlo_menu_type_news');
		animatedMenu.typed({
			strings: ["news();"],
			loop: false,
			//startDelay: 1e3
	...
	jQuery(".arlo_menu_type_contact").one("mouseover", function (e) {
		e.preventDefault();
		var animatedMenu = jQuery('.arlo_menu_type_contact');
		animatedMenu.typed({
			strings: ["contact();"],
			loop: false,
			//startDelay: 1e3
...
function arlo_tm_animate_text(){
	...
	var animateSpan			= jQuery('.arlo_tm_animation_text_word');
		...
		animateSpan.typed({
			strings: ["Freelancer", "UI/UX Designer", "Web and App Developer"],
			loop: true,
			startDelay: 1e3,
			backDelay: 2e3
		});
